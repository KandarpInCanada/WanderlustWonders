...
import { ArrowLeft, Upload, Eye, Save, Send, MapPin, Calendar, Users, Tag } from "lucide-react"
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div className="flex items-center justify-between mb-8 pt-8">
          <div className="flex items-center">
            <button className="inline-flex items-center text-gray-600 hover:text-gray-900 mr-6 transition-all duration-300 group bg-white rounded-full px-4 py-2 shadow-lg hover:shadow-xl">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-white text-gray-700 px-6 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
          >
              ...
              <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-lg border border-white/50 p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-semibold">{Math.max(1, Math.ceil(content.split(' ').length / 200))} min</span>
                  </div>
                </div>
              </div>
